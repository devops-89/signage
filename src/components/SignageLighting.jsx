...
const SignageLighting = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 text-white">
      {/* for desktop */}
      <div className="hidden md:block text-center space-y-6 pt-10 sm:pt-16">
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-3 md:space-x-3" data-aos="fade-right">
          ...
          <h1 className="text-[4vh] sm:text-[10vh] md:text-[13vh] font-semibold uppercase">Signage</h1>
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-3 md:space-x-3" data-aos="fade-left">
          ...
          <h1 className="text-[4vh] sm:text-[10vh] md:text-[13vh] font-semibold uppercase">And</h1>
          <h1 className="text-[4vh] sm:text-[10vh] md:text-[13vh] font-semibold uppercase">Lighting</h1>
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-3 md:space-x-3" data-aos="fade-right">
          ...
          <h1 className="text-[4vh] sm:text-[10vh] md:text-[13vh] font-semibold uppercase">For</h1>
          <h1 className="text-[4vh] sm:text-[10vh] md:text-[13vh] font-semibold uppercase">The</h1>
          ...
          <h1 className="text-[4vh] sm:text-[10vh] md:text-[13vh] font-semibold uppercase">Trade</h1>
      ...
      {/* for mobile */}
      <div className="md:hidden text-center space-y-6 pt-10 sm:pt-16">
